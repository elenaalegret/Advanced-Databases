...
#Inputs:
#  - JDBC connections to DuckDB for loading datasets: Using Spark to directly query DuckDB where the datasets are initially stored in tables.
#
#Outputs:
...
# Apartment Filtration Function: Sidebar controls for dynamic user-driven data filtering
